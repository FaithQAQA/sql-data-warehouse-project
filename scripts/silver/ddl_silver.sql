...
--                 It drops existing tables if they exist and then creates fresh tables 
--                 with the required schema. Each table includes a `dwh_create_date` 
--                 column to track the timestamp of data insertion.
-- Tables Created:
...
CREATE TABLE silver.crm_cust_info(
    ...
    cst_marital_status NVARCHAR(50), -- fixed typo
